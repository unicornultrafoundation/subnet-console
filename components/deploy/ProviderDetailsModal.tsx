      ...
      <ModalContent>
        ...
        <ModalBody className="space-y-6">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-default-900">Available Resources</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-xl">
                <div className="flex items-center gap-2 mb-2">
                  <Cpu className="text-blue-500" size={20} />
                  <span className="font-medium text-default-700">CPU Cores</span>
                </div>
                <div className="text-2xl font-bold text-blue-600">
          ...
          {/* GPU Support Details */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-default-900">GPU Support</h3>
            <div className="bg-gradient-to-r from-orange-50 to-orange-100 p-4 rounded-xl">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    <Monitor className="text-orange-500" size={16} />
                    <span className="font-medium text-default-700">GPU Models</span>
                  </div>
                  <div className="space-y-1">
                    {(provider.gpuModels || ["RTX 4090", "RTX 4080", "RTX 4070", "Tesla V100"]).map((model: string, index: number) => (
                ...
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="font-medium text-default-700">GPU Memory</span>
                  </div>
                  <div className="space-y-1">
                    {(provider.gpuMemory || ["24GB GDDR6X", "16GB GDDR6X", "12GB GDDR6X", "32GB HBM2e"]).map((memory: string, index: number) => (
                      <div key={index} className="text-sm text-orange-700">
                        • {memory}
                      </div>
                    ))}
                ...
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="font-medium text-default-700">Interface</span>
                  </div>
                  <div className="space-y-1">
                    {(provider.gpuInterface || ["PCIe 4.0 x16", "PCIe 3.0 x16", "NVLink", "Infinity Fabric"]).map((gpuInterface: string, index: number) => (
                      <div key={index} className="text-sm text-orange-700">
                        • {gpuInterface}
                      </div>
                    ))}
          ...
          {/* Performance Metrics */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-default-900">Performance Metrics</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white/60 p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  <Clock className="text-blue-500" size={16} />
                  <span className="font-medium text-default-700">Response Time</span>
                </div>
              ...
              <div className="bg-white/60 p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-medium text-default-700">Success Rate</span>
                </div>
          ...
          {provider.features && provider.features.length > 0 && (
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-default-900">Features</h3>
          ...
          {/* Trust Indicators */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-default-900">Trust & Security</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                <Shield className="text-green-500" size={20} />
                <div>
                  <div className="font-medium text-green-700">Verified Provider</div>
                  <div className="text-xs text-green-600">Identity confirmed</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-3 bg-purple-50 rounded-lg">
                ...
                <div>
                  <div className="font-medium text-purple-700">Fast Response</div>
